...
export default function App() {
  ...
  const addNode = (type) => {
      ...
      // Sanitize params for postMessage (remove functions)
      const { onUpload, ...safeParams } = newNode.data;
      audioManager.sendMessage({ type: 'CREATE_NODE', id: id, nodeType: type, params: safeParams });
  };
