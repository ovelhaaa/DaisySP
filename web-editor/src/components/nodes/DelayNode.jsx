...
export default memo(({ id, data }) => {
  ...
  return (
    <div style={{ background: '#90caf9', padding: '10px', borderRadius: '5px', border: '1px solid #777', minWidth: '100px', position: 'relative' }}>
      ...
      <div style={{ fontWeight: 'bold', marginBottom: '5px', textAlign: 'center' }}>Delay</div>

      <div style={{ fontSize: '10px' }}>Time: {data.time || 0.5} s</div>
      <div style={{ fontSize: '10px' }}>Feedback: {data.feedback || 0.5}</div>
      <div style={{ fontSize: '10px' }}>Mix: {data.mix || 0.5}</div>
