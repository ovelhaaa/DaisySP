...
export default memo(({ id, data }) => {
  ...
  return (
    <div style={{ background: '#ce93d8', padding: '10px', borderRadius: '5px', border: '1px solid #777', minWidth: '100px', position: 'relative' }}>
      ...
      <div style={{ fontWeight: 'bold', marginBottom: '5px', textAlign: 'center' }}>Reverb</div>

      <div style={{ fontSize: '10px' }}>Time: {data.time || 0.9}</div>
      <div style={{ fontSize: '10px' }}>Damp: {data.damp || 15000} Hz</div>
